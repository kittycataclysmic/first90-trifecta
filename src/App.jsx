...
const RESULTS = {
  D: {
    ...
    costs: "Clients who experience a disorganised first week feel like they have to manage you — and premium clients don't want to manage their VA. Every day without a clear onboarding process is a day the client's confidence in you slowly erodes, even if they don't say anything.",
...
const SYSTEM_COMPONENTS = [
  ...
  },
  {
    ...
    steps: [
      ...
      { id: "r2", text: "Use the AI prompt from Shift 03 of the Blueprint to write your customised retainer message now — before Day 45. Written in advance means sent with confidence, not panic." },
      ...
      { id: "r4", text: "Practise the rate out loud. Say your monthly rate number three times, alone. The moment you can say it without hesitating is the moment clients accept it without hesitating." },
      ...
      <div style={{ maxWidth: 680, margin: "0 auto", padding: "56px 40px 80px" }} className="fade-up">
        ...
        {stage === "gate" && (
          <div className="fade-up">
            ...
            <p style={{ fontSize: 14.5, lineHeight: 1.85, color: "#333", marginBottom: 36, maxWidth: 480 }}>Enter your name and email to get your personalised diagnosis — exactly where you're at risk of losing this client and the one thing to fix right now.</p>
